    ...
    <div class="container-xl top">
        ...
        <div class="container">
            ...
            @foreach ($recipe_comments as $recipe_comment)
                <div class="row clickable mt-2 "
                    onclick="location.href='/recipes/{{ $recipe->id }}/comments/{{ $recipe_comment->id }}'">
                    <div class="d-flex  @if ($right) justify-content-end @endif ">
                                <div class=" card bg-dark ">
                                  <div class=" card-body">
                        <h5 class="card-title"> {{ $recipe_comment->comment }} </h5>
                        <h6 class="card-content d-flex justify-content-end"> {{ $recipe_comment->user->name }} </h6>
